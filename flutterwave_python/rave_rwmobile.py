...
class RWMobile(Payment):
    ...
    def __init__(self, publicKey, secretKey, encryptionKey, production, usingEnv):
        super(RWMobile, self).__init__(publicKey, secretKey, encryptionKey, production, usingEnv)
    ...
    def charge(self, accountDetails, hasFailed=False):
        ...
        accountDetails.update({"type": "mobile_money_rwanda", "currency":"RWF"})
        ...
        requiredParameters = ["amount", "email", "order_id", "currency", "tx_ref"]
