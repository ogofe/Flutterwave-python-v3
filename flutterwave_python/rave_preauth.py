import requests
import json
from flutterwave_python.rave_exceptions import ServerError, TransactionVerificationError, PreauthCaptureError, PreauthRefundVoidError
...
class Preauth(Card):
    ...
    def __init__(self, publicKey, secretKey, encryptionKey, production, usingEnv):
        super(Preauth, self).__init__(publicKey, secretKey, encryptionKey, production, usingEnv)
