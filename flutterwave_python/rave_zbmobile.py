...
class ZBMobile(Payment):
    ...
    def __init__(self, publicKey, secretKey, encryptionKey, production, usingEnv):
        super(ZBMobile, self).__init__(publicKey, secretKey, encryptionKey, production, usingEnv)
    ...
    def charge(self, accountDetails, hasFailed=False):
        ...
        accountDetails.update({"type": "mobile_money_zambia", "currency":"ZMW"})
